	...
	while (!sair)
	{
		...
		else
		{
			...
			if (codigo == num2) cod2 = true;
				...
				cout << "<DIGITE O TERCEIRO NÚMERO DO CÓDIGO NO TERMINAL> ";
			cin >> codigo;
			if (codigo == num3) cod3 = true;

			cout << "<DIGITE O QUARTO NÚMERO DO CÓDIGO NO TERMINAL> ";
			cin >> codigo;
...
void Mostrar_Circuito(bool cod1, bool cod2, bool cod3, bool cod4)
{
	...
	// Colo
	//Coloque o seu comentário aqui!
	
	//Se o cod2 == true, vai imprimir o de baixo, se não (else) ira mostra o que tem abaixo, e assim por diante no outros. Quando for verdadeiro (true) determinada coisa será mostrada, e quando for falsa (false), vai ser outra;
	// lembrando que muda de varíavel para variável, como cod2,cod4;
	if (cod2 == true)
	{
		cout << "	       ____	" << endl;
		cout << "	      |||||    " << endl;
